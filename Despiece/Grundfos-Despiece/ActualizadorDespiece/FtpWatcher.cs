...
namespace ActualizadorDespiece
{
    ...
    public class FtpWatcher
    {
        ...
        public FtpWatcher()
        {
            wtch = new FileSystemWatcher(ConfigurationManager.AppSettings["ServerPath"], "*.xml");
        ...
        protected static void ActualizarDatos()
        {
            ...
            ds.ReadXml(ConfigurationManager.AppSettings["ServerPath"] + "~/transac.xml");
        ...
        protected static void ActualizarDespiece()
        {
            ...
            ds.ReadXml(ConfigurationManager.AppSettings["ServerPath"] + "~/despiece.xml");
