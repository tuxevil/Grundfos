...
namespace PriceManager.Business
{
    public class ProviderController : AbstractNHibernateDao<Provider, int>
    {
        ...
        public IList<Provider> GetProviderList(string description, Country country, ProviderStatus? status, Incoterm? saleCondition,
        ...
        public void Updates(int providerId, string description, string city, int leadTime, string mail,
                            Lookup purchaseType, Country country, Incoterm? saleCondition, decimal discount)
        {
