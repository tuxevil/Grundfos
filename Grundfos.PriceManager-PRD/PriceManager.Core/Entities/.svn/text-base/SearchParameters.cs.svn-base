...
namespace PriceManager.Core
{
    ...
    public class SearchParameters
    {
        ...
        private int[] categories = new int[6];
        ...
        private Guid priceImport;
        public Guid PriceImport
        {
        ...
        private int publishList;
        public int PublishList
        {
        ...
        private int categoryBase;
        public int CategoryBase
        {
