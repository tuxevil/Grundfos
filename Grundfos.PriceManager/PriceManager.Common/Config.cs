...
namespace PriceManager.Common
{
    public class Config
    {
        ...
        public static string CanCreateContact
        {
            get { return "CanCreateContact"; }
        }

        public static string BestQuoteRange
        {
            get { return "BestQuoteRange"; }
        }

        public static string CanSeeImportantQuoteData
        {
            get { return "CanSeeImportantQuoteData"; }
        }
    }
}