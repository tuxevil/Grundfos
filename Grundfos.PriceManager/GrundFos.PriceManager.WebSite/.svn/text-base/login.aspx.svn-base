<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="GrundFos.PriceManager.WebSite.login" Title="Prices Manager Advanced - Inicio de Sesión"%>
    ...
    <div class="login">
        ...
        <div id="login_dialog" class="login_dialog">
            ...
            <div id="user_name_login">
                <asp:Login ID="Login1" runat="server" DestinationPageUrl="~/default.aspx" OnLoginError="Login1_LoginError" OnLoggedIn="Login1_LoggedIn" OnLoggingIn="Login1_LoggingIn" >
                  <LayoutTemplate>
                      <h2>Usuario</h2>
                  ...
                  <div class="extras">
                    <ul>
                      <li><a href="/forgot.aspx">Olvidé mi contraseña</a>
                      </li>
                      <li><a href="/changepassword.aspx">Cambiar contraseña</a>
                      </li>
                    </ul>
                  </div>
