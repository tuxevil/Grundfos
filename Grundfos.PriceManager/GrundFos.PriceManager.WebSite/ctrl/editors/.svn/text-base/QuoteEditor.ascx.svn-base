...
<div style="width:20%;float:right;">
    ...
    <ContentTemplate>
        <center>
           <asp:CustomValidator ID="CustomValidator1" Display="Dynamic" runat="server" CssClass="validations" ErrorMessage="Canal de Ventas incorrecto. Por favor, verifíquelo." ControlToValidate="txtDistributor" OnServerValidate="CustomValidator1_ServerValidate" ValidationGroup="form"></asp:CustomValidator><br />
           ...
           <asp:CustomValidator ID="CustomValidator3" Display="Dynamic" runat="server" CssClass="validations" ErrorMessage="Asegúrese de seleccionar un texto introductorio y una condición." ValidationGroup="form" OnServerValidate="CustomValidator3_ServerValidate"></asp:CustomValidator><br />
       ...
       <div style="width:35%;float:right;" >
        ...
        <div style="width:65%">
            <fieldset>
              ...
              <div><label>Condición</label><asp:DropDownList ID="ddlQuoteCondition" runat="server" TabIndex="10" Width="224px"></asp:DropDownList></div>
              <div><label>Descripción</label><asp:TextBox ID="txtDescripcion" runat="server" MaxLength="50" Width="220px" TabIndex="15"></asp:TextBox></div>
              ...
              <div><label>Vigencia (días)</label><asp:DropDownList ID="ddlQuoteVigency" runat="server" ValidationGroup="VigencyCheck" TabIndex="25" Width="50px"></asp:DropDownList><br /></div>
              <div><label>Email adicional</label><asp:TextBox ID="txtEmail" runat="server" TabIndex="30" MaxLength="50" Width="220px"></asp:TextBox><asp:RegularExpressionValidator ID="rev" runat="server" ErrorMessage="Ingrese un Email válido" ControlToValidate="txtEmail" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator><br /></div>
