...
namespace PriceManager.Repositories
{
    public class DistributorRepository : AbstractNHibernateDao<Distributor, int>, IDistributorRepository
    {
        ...
        public IList<Distributor> GetDistributors(string name, Country country, PriceList priceList, Lookup paymentTerm, DistributorStatus? status, GridState gridState, out int totalRecords, Incoterm? saleCondition, Lookup type, CatalogPage page, IList priceListIds, bool isActive)
        {
        ...
        public IList<Contact> GetActiveContacts()
        {
            ...
            crit.Add(Expression.Eq("Status", ContactStatus.Active)).AddOrder(new Order("LastName", true));
        ...
        public IList<Contact> GetContacts()
        {
            ...
            crit.AddOrder(new Order("LastName", true));
        ...
        return crit.UniqueResult<Contact>();
        }
