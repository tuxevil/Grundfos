namespace SistemaPC
{
    ...
    public class frmDiscrepanciasOC : Form
    {
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            {
                Interaction.MsgBox("Nro.L\x00ednea inv\x00e1lido", MsgBoxStyle.Critical, "Operador");
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        if (Interaction.MsgBox("Nro.OC - L\x00ednea inexistente en Scala, genera Reclamo?", MsgBoxStyle.YesNo, "Operador") == MsgBoxResult.Yes)
                        {
                            this.AdapRecepcion.Update(this.DS, "Recepcion");
                            this.DS.Tables["Recepcion"].AcceptChanges();
