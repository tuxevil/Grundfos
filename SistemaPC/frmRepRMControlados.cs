namespace SistemaPC
{
    ...
    public class frmRepRMControlados : Form
    {
        ...
        public frmRepRMControlados()
        {
            base.Closed += new EventHandler(this.frmRepRMControlados_Closed);
            base.Load += new EventHandler(this.frmRepRMControlados_Load);
            this.DS = new DataSet();
        ...
        private void frmRepRMControlados_Closed(object sender, EventArgs e)
        {
            new frmMenuExp().Show();
        }

        private void frmRepRMControlados_Load(object sender, EventArgs e)
        {
        }
        ...
        {
            ResourceManager manager = new ResourceManager(typeof(frmRepRMControlados));
            ...
            this.Label2.Text = "Reporte Remitos Controlados";
