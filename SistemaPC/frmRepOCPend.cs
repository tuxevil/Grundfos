namespace SistemaPC
{
    ...
    public class frmRepOCPend : Form
    {
        ...
        private void cmbAceptar_Click(object sender, EventArgs e)
        {
            ...
            {
                Interaction.MsgBox("Debe ingresar ambas fechas o ninguna", MsgBoxStyle.Critical, "Operador");
        ...
        {
            this.dtpDesde.Value = DateAndTime.Now;
            this.dtpHasta.Value = DateAndTime.Now;
            bool flag = false;
            try
            {
