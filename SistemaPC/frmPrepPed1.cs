    ...
    public class frmPrepPed1 : Form
    {
        ...
        private void ActTmp()
        {
                        ...
                        if (ObjectType.ObjTst(row["Producto"], 1, false) == 0)
                        {
                            ...
                            if (reader.Read())
                            {
                                ...
                                catch (Exception exception20)
                                {
                                    ...
                                    Interaction.MsgBox("Se ha producido el siguiente error:" + exception8.Message, MsgBoxStyle.OKOnly, null);
                                    this.cmbAceptar.Enabled = true;
                                    this.cmbSalir.Enabled = true;
                                    connection2.Close();
                                    this.cmbAceptar.Focus();
                                ...
                                while (num2 <= num20)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        catch (Exception exception21)
                                        {
                                            ...
                                            Interaction.MsgBox("Se ha producido el siguiente error:" + exception9.Message, MsgBoxStyle.OKOnly, null);
                                            this.cmbAceptar.Enabled = true;
                                            this.cmbSalir.Enabled = true;
                                            connection2.Close();
                                            this.cmbAceptar.Focus();
                            ...
                            else if (ObjectType.ObjTst(row["Producto"], 1, false) == 0)
                            {
                                ...
                                if (reader.Read())
                                {
                                    ...
                                    catch (Exception exception22)
                                    {
                                        ...
                                        Interaction.MsgBox("Se ha producido el siguiente error:" + exception10.Message, MsgBoxStyle.OKOnly, null);
                                        this.cmbAceptar.Enabled = true;
                                        this.cmbSalir.Enabled = true;
                                        connection2.Close();
                                        this.cmbAceptar.Focus();
            ...
            for (num2 = 0; num2 <= num19; num2++)
            {
                ...
                if (num8 != 0)
                {
                    ...
                    catch (Exception exception23)
                    {
                        ...
                        Interaction.MsgBox("Se ha producido el siguiente error:" + exception11.Message, MsgBoxStyle.OKOnly, null);
                        reader.Close();
                        connection.Close();
                        connection2.Close();
                        ProjectData.ClearProjectError();
            ...
            catch (Exception exception24)
            {
                ...
                Interaction.MsgBox("Se ha producido el siguiente error:" + exception12.Message, MsgBoxStyle.OKOnly, null);
                reader.Close();
                connection.Close();
                connection2.Close();
                ProjectData.ClearProjectError();
            ...
            for (num2 = 0; num2 <= num17; num2++)
            {
                ...
                if (this.DS1.Tables["ImpEAPrePed"].Rows.Count != 0)
                {
                    ...
                    catch (Exception exception25)
                    {
                        ...
                        Interaction.MsgBox("Se ha producido el siguiente error:" + exception13.Message, MsgBoxStyle.OKOnly, null);
                        reader.Close();
                        connection.Close();
                        connection2.Close();
                        ProjectData.ClearProjectError();
        ...
        private void cmbAceptar_Click(object sender, EventArgs e)
        {
            ...
            {
                Interaction.MsgBox("Debe seleccionar O.Venta", MsgBoxStyle.Critical, "Operador");
                this.dgPrepPed.Focus();
            }
            else if ((StringType.StrCmp(this.mImpreso, "S", false) == 0) && (Interaction.MsgBox("De esta O.Venta ya se imprimieron etiquetas, desea imprimir etiquetas nuevamente?", MsgBoxStyle.YesNo, "Operador") == MsgBoxResult.No))
            {
                this.dgPrepPed.Focus();
            }
            else
            {
                ...
                else
                {
                    reader.Close();
                    connection.Close();
                    Interaction.MsgBox("Esta O.Venta no se puede preparar", MsgBoxStyle.Information, "Operador");
                ...
                else
                {
                    reader.Close();
                    connection.Close();
                    Interaction.MsgBox("Nro.O.Venta inexistente", MsgBoxStyle.Information, "Operador");
                    this.dgPrepPed.Enabled = true;
                    this.cmbSalir.Enabled = true;
                    this.dgPrepPed.Focus();
                    return;
