        ...
        public frmConsultaOV2()
        {
            ...
            try
            {
                ...
                if ((Variables.gCodEstado == 1) | (Variables.gCodEstado == 4))
                {
                    ...
                    connection.Close();
                    FormulaFieldDefinition definition = this.Informe.DataDefinition.FormulaFields["Titulo"];
                    if (Variables.gCodEstado == 1)
                    {
                        definition.Text = "'Consulta Ordenes de Venta - Estado Pendiente de Entrega'";
                    }
                    else
                    {
                        definition.Text = "'Consulta Ordenes de Venta - Estado Preparado pend.imp.doc.exp.'";
                    }
                ...
                if ((Variables.gCodEstado == 3) | (Variables.gCodEstado == 5))
                {
                    ...
                    this.Informe.SetDataSource(this.DS);
                    connection.Close();
                    FormulaFieldDefinition definition2 = this.Informe.DataDefinition.FormulaFields["Titulo"];
                    if (Variables.gCodEstado == 3)
                    {
                        definition2.Text = "'Consulta Ordenes de Venta - Estado Expedido'";
                    }
                    else
                    {
                        definition2.Text = "'Consulta Ordenes de Venta - Estado Recepci\x00f3n Conformada'";
                    }
                    this.CrystalReportViewer1.ReportSource = this.Informe;
                }
            }
