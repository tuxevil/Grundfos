namespace SistemaPC
{
    ...
    public class frmRepDifInv : Form
    {
        ...
        private void cmbAceptar_Click(object sender, EventArgs e)
        {
            ...
            {
                Interaction.MsgBox("Debe ingresar referencia", MsgBoxStyle.Critical, "Operador");
            ...
            else
            {
                ...
                {
                    Interaction.MsgBox("No se gener\x00f3 diferencia de inventario sobre estos datos", MsgBoxStyle.Critical, "Operador");
                    connection.Close();
