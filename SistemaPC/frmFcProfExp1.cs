namespace SistemaPC
{
    ...
    public class frmFcProfExp1 : Form
    {
        ...
        private void btnIngresar_Click(object sender, EventArgs e)
        {
            ...
            {
                Interaction.MsgBox("Debe ingresar importe flete", MsgBoxStyle.Critical, "Operador");
                this.editFlete.Focus();
            }
            else if (!Information.IsNumeric(this.editFlete.Text))
            {
                Interaction.MsgBox("Importe flete debe ser num\x00e9rico", MsgBoxStyle.Critical, "Operador");
                this.editFlete.Focus();
            }
            else if (((!this.rbAereo.Checked & !this.rbTerrestre.Checked) & !this.rbMaritimo.Checked) & !this.rbCourier.Checked)
            {
                Interaction.MsgBox("Debe indicar tipo de flete", MsgBoxStyle.Critical, "Operador");
                this.rbAereo.Focus();
            }
            else
            {
        ...
        private void cmbAceptar_Click(object sender, EventArgs e)
        {
            ...
            {
                Interaction.MsgBox("Debe seleccionar Ordenes de Venta", MsgBoxStyle.Critical, "Operador");
            }
            else
            {
        ...
        {
            bool flag = false;
            if ((this.DS.Tables[Variables.gTermi + "TmpOVFCProExp"].Rows.Count != 0) && (Interaction.MsgBox("Desea eliminar esta OV", MsgBoxStyle.YesNo, "Operador") == MsgBoxResult.Yes))
            {
