        ...
        private void GenOC()
        {
            ...
            try
            {
                ...
                for (num = 0; num <= num8; num++)
                {
                    ...
                    str = (((((StringType.FromObject(ObjectType.StrCatObj(StringType.FromObject(ObjectType.StrCatObj(StringType.FromObject(ObjectType.StrCatObj(Strings.Format(num4, "0000000000") + "1" + Strings.Format(num3, "000000"), ObjectType.AddObj(row["Codigo"], Strings.Space(0x23 - Strings.Len(RuntimeHelpers.GetObjectValue(row["Codigo"])))))) + Strings.Format(RuntimeHelpers.GetObjectValue(row["CantMetEnv01"]), "00000000000.00000000"), ObjectType.AddObj(row["CodProv"], Strings.Space(10 - Strings.Len(RuntimeHelpers.GetObjectValue(row["CodProv"])))))) + Strings.Format(DateAndTime.Now, "ddMMyyyy") + Strings.Format(RuntimeHelpers.GetObjectValue(row["FecEntOC01"]), "ddMMyyyy"), row["CodMetEnv01"])) + Strings.Mid(Variables.gAlmacen1, 1, 2) + Strings.Space(6 - Strings.Len(Strings.Mid(Variables.gAlmacen1, 1, 2)))) + str4 + Strings.Space(2 - Strings.Len(str4))) + Strings.Space(0x23) + Strings.Space(0x23)) + Strings.Space(0x23) + Strings.Space(0x23)) + Strings.Space(0x23) + Strings.Space(10)) + Strings.Space(12) + "\r" + "\n";
                ...
                for (num = 0; num <= num7; num++)
                {
                    ...
                    str = (((((StringType.FromObject(ObjectType.StrCatObj(StringType.FromObject(ObjectType.StrCatObj(StringType.FromObject(ObjectType.StrCatObj(Strings.Format(num4, "0000000000") + "1" + Strings.Format(num3, "000000"), ObjectType.AddObj(row["Codigo"], Strings.Space(0x23 - Strings.Len(RuntimeHelpers.GetObjectValue(row["Codigo"])))))) + Strings.Format(RuntimeHelpers.GetObjectValue(row["CantMetEnv02"]), "00000000000.00000000"), ObjectType.AddObj(row["CodProv"], Strings.Space(10 - Strings.Len(RuntimeHelpers.GetObjectValue(row["CodProv"])))))) + Strings.Format(DateAndTime.Now, "ddMMyyyy") + Strings.Format(RuntimeHelpers.GetObjectValue(row["FecEntOC02"]), "ddMMyyyy"), row["CodMetEnv02"])) + Strings.Mid(Variables.gAlmacen1, 1, 2) + Strings.Space(6 - Strings.Len(Strings.Mid(Variables.gAlmacen1, 1, 2)))) + str4 + Strings.Space(2 - Strings.Len(str4))) + Strings.Space(0x23) + Strings.Space(0x23)) + Strings.Space(0x23) + Strings.Space(0x23)) + Strings.Space(0x23) + Strings.Space(10)) + Strings.Space(12) + "\r" + "\n";
                    writer = new StreamWriter(Variables.gPathTxt + @"\genocompra.prn", true);
                    writer.Write(str);
                    writer.Close();
                    num2++;
                ...
                for (num = 0; num <= num6; num++)
                {
                    ...
                    str = (((((StringType.FromObject(ObjectType.StrCatObj(StringType.FromObject(ObjectType.StrCatObj(StringType.FromObject(ObjectType.StrCatObj(Strings.Format(num4, "0000000000") + "1" + Strings.Format(num3, "000000"), ObjectType.AddObj(row["Codigo"], Strings.Space(0x23 - Strings.Len(RuntimeHelpers.GetObjectValue(row["Codigo"])))))) + Strings.Format(RuntimeHelpers.GetObjectValue(row["CantMetEnv03"]), "00000000000.00000000"), ObjectType.AddObj(row["CodProv"], Strings.Space(10 - Strings.Len(RuntimeHelpers.GetObjectValue(row["CodProv"])))))) + Strings.Format(DateAndTime.Now, "ddMMyyyy") + Strings.Format(RuntimeHelpers.GetObjectValue(row["FecEntOC03"]), "ddMMyyyy"), row["CodMetEnv03"])) + Strings.Mid(Variables.gAlmacen1, 1, 2) + Strings.Space(6 - Strings.Len(Strings.Mid(Variables.gAlmacen1, 1, 2)))) + str4 + Strings.Space(2 - Strings.Len(str4))) + Strings.Space(0x23) + Strings.Space(0x23)) + Strings.Space(0x23) + Strings.Space(0x23)) + Strings.Space(0x23) + Strings.Space(10)) + Strings.Space(12) + "\r" + "\n";
                    writer = new StreamWriter(Variables.gPathTxt + @"\genocompra.prn", true);
                    writer.Write(str);
                    writer.Close();
                    num2++;
