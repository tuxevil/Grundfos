namespace SistemaPC
{
    ...
    public class frmConsultaOV : Form
    {
        ...
        private void cmbAceptar_Click(object sender, EventArgs e)
        {
            ...
            {
                Interaction.MsgBox("Sucursal debe ser num\x00e9rica", MsgBoxStyle.Critical, "Operador");
            ...
            {
                Interaction.MsgBox("Nro.Remito debe ser num\x00e9rico", MsgBoxStyle.Critical, "Operador");
            ...
            {
                Interaction.MsgBox("Debe ingresar Nro.Remito", MsgBoxStyle.Critical, "Operador");
                this.editNroRM.Focus();
            }
            else if ((StringType.StrCmp(this.editSucRM.Text, Strings.Space(0), false) == 0) & (StringType.StrCmp(this.editNroRM.Text, Strings.Space(0), false) != 0))
            {
                Interaction.MsgBox("Debe ingresar Sucursal del Remito", MsgBoxStyle.Critical, "Operador");
                this.editSucRM.Focus();
            }
            else
            {
