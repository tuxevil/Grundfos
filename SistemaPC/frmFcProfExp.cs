namespace SistemaPC
{
    ...
    public class frmFcProfExp : Form
    {
        ...
        private void cmbAceptar_Click(object sender, EventArgs e)
        {
            ...
            {
                Interaction.MsgBox("Debe indicar Cliente", MsgBoxStyle.Critical, "Operador");
            ...
            else
            {
                ...
                {
                    Interaction.MsgBox("No hay \x00f3rdenes de venta para este cliente", MsgBoxStyle.Critical, "Operador");
                    this.editCodCli.Text = "";
