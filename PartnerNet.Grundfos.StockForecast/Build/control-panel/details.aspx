...
<asp:ScriptManager ID="ScriptManager1" runat="server" />
    ...
    <asp:GridView ID="GVSeguimientoOc" runat="server" AllowPaging="True" AutoGenerateColumns="False"
        ...
        PageSize="25" OnPageIndexChanging="GVOcConfirmadasNoEntregadas_PageIndexChanging" AllowSorting="True" OnSorting="GVOcConfirmadasNoEntregadas_Sorting" OnRowDataBound="GVOcConfirmadasNoEntregadas_RowDataBound">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Quantity" SortExpression="Quantity" HeaderText="Cantidad" ItemStyle-HorizontalAlign="Right" />
            ...
            <asp:BoundField DataField="GAP" SortExpression="GAP" HeaderText="GAP" ItemStyle-HorizontalAlign="Right" />
    ...
    <asp:GridView ID="GVStockNegativo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Quantity" SortExpression="Quantity" HeaderText="Cantidad" ItemStyle-HorizontalAlign="Right" />
            <asp:BoundField DataField="SubTotal" SortExpression="SubTotal" HeaderText="SubTotal" DataFormatString="{0:$ #,##0.000}" ItemStyle-HorizontalAlign="Right" />
    ...
    <asp:GridView ID="GVSeguimientoOV" runat="server" AllowPaging="True" AutoGenerateColumns="False"
        CellPadding="4" CssClass="text1" ForeColor="#333333" GridLines="None"
        PageSize="25" OnPageIndexChanging="GVNoCumplimentadas_PageIndexChanging" AllowSorting="True" OnSorting="GVNoCumplimentadas_Sorting" OnRowDataBound="GVNoCumplimentadas_RowDataBound">
        <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
        <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
        <Columns>
            <asp:BoundField DataField="SaleOrderCode" SortExpression="SaleOrderCode" HeaderText="OV" ItemStyle-HorizontalAlign="Right" />
            <asp:HyperLinkField DataNavigateUrlFields="ProductCode" DataNavigateUrlFormatString="~/product-list/default.aspx?productcode={0}"
                DataTextField="ProductCode" SortExpression="Product.ProductCode" HeaderText="Producto" ItemStyle-HorizontalAlign="Right" />
    ...
    <asp:Panel ID="pnStockMenorSafety" runat="server" Visible="False">
    <asp:GridView ID="GVStockMenorSafety" runat="server" AllowPaging="True" AutoGenerateColumns="False"
        ...
        <Columns>
            <asp:HyperLinkField DataNavigateUrlFields="ProductCode" DataNavigateUrlFormatString="~/product-list/default.aspx?productcode={0}"
                DataTextField="ProductCode" SortExpression="ProductCode" HeaderText="Producto" ItemStyle-HorizontalAlign="Right" />
            <asp:BoundField DataField="NegativeDate" SortExpression="NegativeDate" HeaderText="Fecha de Quiebre" DataFormatString="{0:dd/MM/yyyy}" />
            <asp:BoundField DataField="Quantity" SortExpression="Quantity" HeaderText="Cantidad" ItemStyle-HorizontalAlign="Right" />
        </Columns>
        <PagerStyle BackColor="#284775" ForeColor="White" HorizontalAlign="Center" />
        <SelectedRowStyle BackColor="#E2DED6" Font-Bold="True" ForeColor="#333333" />
    ...
    <asp:Panel ID="pnReposicionDiferente" runat="server" Visible="False">
        ...
        CellPadding="4" CssClass="text1" ForeColor="#333333" GridLines="None"
        PageSize="25" AllowSorting="True" OnPageIndexChanging="GVReposicionDiferente_PageIndexChanging" OnSorting="GVReposicionDiferente_Sorting" OnRowDataBound="GVReposicionDiferente_RowDataBound" OnRowCommand="GVReposicionDiferente_RowCommand" >
        <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
        <Columns>
            <asp:HyperLinkField DataNavigateUrlFields="ProductCode" DataNavigateUrlFormatString="~/product-list/default.aspx?productcode={0}"
                DataTextField="ProductCode" SortExpression="Product.ProductCode" HeaderText="Producto" />
            ...
            <asp:BoundField DataField="Sales" HeaderText="VTA. 12M" SortExpression="Sales" ItemStyle-HorizontalAlign="Right" />
            <asp:BoundField DataField="CuatrimestralSales" HeaderText="Niv. Prop" AccessibleHeaderText="Nivel de Reposición Propuesto" SortExpression="Sales" ItemStyle-HorizontalAlign="Right" />
            <asp:BoundField DataField="SaleMonths" HeaderText="Vida del Producto(Meses)" ItemStyle-HorizontalAlign="Right" />
            <asp:BoundField DataField="RepositionLevel" HeaderText="Niv. Repos."
                SortExpression="Product.RepositionLevel" ItemStyle-HorizontalAlign="Right" />
            <asp:BoundField DataField="Result" HeaderText="Diferencia %" SortExpression="Result" ItemStyle-HorizontalAlign="Right" />
            <asp:BoundField DataField="Price" HeaderText="Precio" ItemStyle-HorizontalAlign="Right" />
            <asp:BoundField DataField="Provider" HeaderText="Proveedor" />
            <asp:BoundField DataField="OrderInfo" HeaderText="Info OV (Cant. Ordenes/%/N. Orden)" ItemStyle-HorizontalAlign="Right" />
