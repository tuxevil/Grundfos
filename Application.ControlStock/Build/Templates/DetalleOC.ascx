...
<table style="width: 800px; height: 150px">
    <tr>
        ...
        <td rowspan="3" valign="top" style="width: 134px">
            ...
            <a style="cursor:pointer" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','../images/btn_exp_oc2.gif',1)"><img src="../images/btn_exp_oc.gif" alt="Exportar OC" name="Image3" width="131" height="21" border="0"></a>
