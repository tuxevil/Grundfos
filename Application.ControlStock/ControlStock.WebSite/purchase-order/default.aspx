            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <table width="90%" border="0" cellspacing="3" cellpadding="0">
                    <tr>
                        ...
                        <td class="text1" style="height: 24px"><asp:CustomValidator ID="CustomValidator1" runat="server" ControlToValidate="TextBox1"
                            ErrorMessage="Seleccione un Filtro!" Font-Bold="True" Font-Size="Small" OnServerValidate="CustomValidator1_ServerValidate" CssClass="text4"></asp:CustomValidator>
                        </td>
                        <td align="right" style="height: 24px">
                        </td>
                        <td style="height: 24px">
                        </td>
                        <td style="height: 24px" width="64">
                        </td>
                        <td style="height: 24px" width="136">
                        </td>
                        <td style="height: 24px" width="131">
                        </td>
                    </tr>
                    <tr>
                        <td align="right" class="text1" style="height: 24px">
                        ...
                        <td width="131" style="height: 24px"><a style="cursor:pointer" onmouseout="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image13','','../images/btn_imp_oc_s2-07.gif',1)"><asp:ImageButton ID="ImageButton5" runat="server" ImageUrl="../images/btn_imp_oc_s-07.gif" AlternateText="Generar orden de compra" Width="131" Height="21" BorderWidth="0" OnClick="ImageButton5_Click" /></a></td>
                    </tr>
                    <tr>
                        ...
                        <td width="136"><a style="cursor:pointer" onmouseout="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image12','','../images/btn_imp_oc_s2.gif',1)"><asp:ImageButton ID="Image12" runat="server" ImageUrl="../images/btn_imp_oc_s.gif" AlternateText="Imprimir OC sel" Width="131" Height="21" BorderWidth="0" OnClick="Image12_Click" /></a></td>
                    ...
                    <tr>
                        ...
                        <td colspan="2"><asp:Label ID="Label6" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Red"
                            Text="Por favor seleccione al menos 1 producto!"
                            Visible="False" CssClass="text4"></asp:Label>
                        </td>
                    </tr>
                </table>
                            <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="TextBox2" Format="MM/dd/yyyy">
