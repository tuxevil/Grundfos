...
<body>
    ...
    <asp:Button runat="server" ID="btnTest" OnClick="btnTest_Click" Text="Generar OC Automaticas" />
        ...
        <asp:Button ID="Button5" runat="server" OnClick="Button5_Click" Text="Generar Transacciones"
            Width="250px" /><br />
        <asp:Button ID="Button6" runat="server" OnClick="Button6_Click" Text="Generar Promedios"
            Width="250px" /><br />
        <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Generar Forecast" /><asp:TextBox ID="TextBox1" runat="server"></asp:TextBox></div>
    </form>
</body>
</html>
