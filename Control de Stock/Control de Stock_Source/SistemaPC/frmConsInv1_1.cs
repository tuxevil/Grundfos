    ...
    public class frmConsInv1_1 : Form
    {
        ...
        public frmConsInv1_1()
        {
            ...
            try
            {
                ...
                connection.Open();
                SqlCommand command = new SqlCommand("SELECT distinct Posicion,FechaInv from Inventario where FechaInv<'" + Strings.Format(DateAndTime.DateAdd(2, (double) (Variables.gCantMeses * -1), DateAndTime.get_Now()), "MM/dd/yyyy") + "'", connection);
                ...
                connection.Close();
                this.Informe.get_DataDefinition().get_FormulaFields().get_Item("cantmeses").set_Text("'" + Strings.Format(Variables.gCantMeses, "##0") + "'");
