namespace SistemaPC
{
    ...
    public class frmGenOCExp : Form
    {
        ...
        private void ActTmp()
        {
            ...
            {
                Interaction.MsgBox("O.Venta inexistente", 0x10, "Operador");
                this.gErrorAct = true;
                connection.Close();
                connection2.Close();
                this.editNroOV.Text = "";
            ...
            else
            {
                ...
                for (long i = 0L; i <= num4; i += 1L)
                {
                    ...
                    int num2 = Strings.InStr(this.cbProveedor.Text, "-", 1);
        ...
        private void cmbAceptar_Click(object sender, EventArgs e)
        {
            ...
            {
                Interaction.MsgBox("Debe ingresar Nro. O.Venta", 0x10, "Operador");
                this.editNroOV.Focus();
            }
            else if (!Information.IsNumeric(this.editNroOV.Text))
            {
                Interaction.MsgBox("Nro. O.Venta debe ser num\x00e9rico", 0x10, "Operador");
                this.editNroOV.Focus();
            }
