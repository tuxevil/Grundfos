    ...
    public class frmGenDifInv : Form
    {
        ...
        private void cmbAceptar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Interaction.MsgBox("Ya se gener\x00f3 diferencia de inventario sobre estos datos", 0x10, "Operador");
                    if (flag)
                    {
                ...
                else
                {
                    ...
                    {
                        Interaction.MsgBox("No se realizo inventario f\x00edsico en la fecha indicada", 0x10, "Operador");
                        if (flag)
                        {
                            transaction.Rollback();
                            flag = false;
