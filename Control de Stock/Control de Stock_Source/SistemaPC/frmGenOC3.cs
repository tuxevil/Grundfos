    ...
    public class frmGenOC3 : Form
    {
        ...
        public frmGenOC3()
        {
            ...
            try
            {
                ...
                connection.Close();
                this.Informe.get_DataDefinition().get_FormulaFields().get_Item("almacen").set_Text("'Almacen: " + Strings.Trim(Variables.gAlmacen1) + "'");
        ...
        private void frmGenOC3_Click(object sender, EventArgs e)
        {
        }

        private void frmGenOC3_Closed(object sender, EventArgs e)
        {
            new frmGenOC1().Show();
        }

        private void frmGenOC3_Load(object sender, EventArgs e)
        {
        }
        ...
        {
            ResourceManager manager = new ResourceManager(typeof(frmGenOC3));
            ...
            this.Name = "frmGenOC3";
            this.Text = "Generaci\x00f3n Ordenes de Compra - O. Compra Generadas";
