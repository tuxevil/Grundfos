namespace SistemaPC
{
    ...
    public class frmRepProdPendExp1 : Form
    {
        ...
        public frmRepProdPendExp1()
        {
            base.Closed += new EventHandler(this.frmRepProdPendExp1_Closed);
            base.Load += new EventHandler(this.frmRepProdPendExp1_Load);
            ...
            this.AdapProdPend = new SqlDataAdapter("Select NroOV,NroLinea,EstLinea,Codigo,Desc1,Desc2,CantOrden,CantPrep,FechaPrep,NroRemito,Cliente,NomCli,OCompra,FechaOV from PrepPed where ContFinal='N'", selectConnectionString);
            ...
            if (Variables.gOrdenProdPend == 1)
            {
                ...
                this.Informe.Load(Application.StartupPath + @"\repprodpend.rpt");
            }
            else if (Variables.gOrdenProdPend == 2)
            {
                this.CrystalReportViewer1.set_ShowGroupTreeButton(false);
                this.Informe.Load(Application.StartupPath + @"\repprodpend2.rpt");
            }
            else if (Variables.gOrdenProdPend == 3)
            {
                this.CrystalReportViewer1.set_ShowGroupTreeButton(true);
                this.Informe.Load(Application.StartupPath + @"\repprodpend3.rpt");
            }
            else if (Variables.gOrdenProdPend == 4)
            {
                this.CrystalReportViewer1.set_ShowGroupTreeButton(false);
                this.Informe.Load(Application.StartupPath + @"\repprodpend4.rpt");
            }
            else if (Variables.gOrdenProdPend == 5)
            {
                this.CrystalReportViewer1.set_ShowGroupTreeButton(false);
                this.Informe.Load(Application.StartupPath + @"\repprodpend5.rpt");
            }
        ...
        private void CrystalReportViewer1_ReportRefresh(object source, ViewerEventArgs e)
        {
            ...
            this.AdapProdPend = new SqlDataAdapter("Select NroOV,NroLinea,EstLinea,Codigo,Desc1,Desc2,CantOrden,CantPrep,FechaPrep,NroRemito,Cliente,NomCli,OCompra,FechaOV from PrepPed where ContFinal='N'", connectionString);
            this.DS.Clear();
            this.AdapProdPend.Fill(this.DS, "PrepPed");
            if (Variables.gOrdenProdPend == 1)
            {
        ...
        private void frmRepProdPendExp1_Closed(object sender, EventArgs e)
        {
            new frmRepProdPendExp().Show();
        }

        private void frmRepProdPendExp1_Load(object sender, EventArgs e)
        {
        }
        ...
        {
            ResourceManager manager = new ResourceManager(typeof(frmRepProdPendExp1));
