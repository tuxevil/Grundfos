    ...
    public class frmRepRMDesp1 : Form
    {
        ...
        public frmRepRMDesp1()
        {
            ...
            try
            {
                ...
                FormulaFieldDefinition definition = definitions.get_Item("desdefecha");
                ...
                FormulaFieldDefinition definition2 = definitions.get_Item("hastafecha");
        ...
        private void CrystalReportViewer1_ReportRefresh(object source, ViewerEventArgs e)
        {
            ...
            if (StringType.StrCmp(Variables.gDesde, Strings.Space(0), false) != 0)
            {
                definition.set_Text("'" + Strings.Format(DateType.FromString(Variables.gDesde), "dd/MM/yyyy HH:mm:ss") + "'");
            }
            else
            {
                definition.set_Text("''");
            ...
            if (StringType.StrCmp(Variables.gHasta, Strings.Space(0), false) != 0)
            {
                definition2.set_Text("'" + Strings.Format(DateType.FromString(Variables.gHasta), "dd/MM/yyyy HH:mm:ss") + "'");
            }
            else
            {
                definition2.set_Text("''");
