namespace SistemaPC
{
    ...
    public class frmGenOCExp3 : Form
    {
        ...
        public frmGenOCExp3()
        {
            base.Closed += new EventHandler(this.frmGenOCExp3_Closed);
            base.Load += new EventHandler(this.frmGenOCExp3_Load);
            base.Click += new EventHandler(this.frmGenOCExp3_Click);
            ...
            try
            {
                ...
                this.Informe.Load(Application.StartupPath + @"\OCGenExp.rpt");
        ...
        private void frmGenOCExp3_Click(object sender, EventArgs e)
        {
        }

        private void frmGenOCExp3_Closed(object sender, EventArgs e)
        {
            new frmGenOCExp1().Show();
        }

        private void frmGenOCExp3_Load(object sender, EventArgs e)
        {
        }
        ...
        {
            ResourceManager manager = new ResourceManager(typeof(frmGenOCExp3));
            ...
            this.Name = "frmGenOCExp3";
            this.Text = "Generaci\x00f3n Ordenes de Compra Exportaci\x00f3n - O. Compra Generadas";
