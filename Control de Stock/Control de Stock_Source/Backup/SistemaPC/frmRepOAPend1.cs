namespace SistemaPC
{
    ...
    public class frmRepOAPend1 : Form
    {
        ...
        private void cmbSalir_Click(object sender, EventArgs e)
        {
            if (Variables.gOrdenOA == 1)
            {
                frmRepOAPend2 pend = new frmRepOAPend2();
                this.Hide();
                pend.Show();
            }
            else
        ...
        private void CrystalReportViewer1_ReportRefresh(object source, ViewerEventArgs e)
        {
            ...
            if (Variables.gOrdenOA == 1)
            {
                ...
                this.Informe.Load(Application.StartupPath + @"\repoapendcalatr.rpt");
                this.Informe.SetDataSource(this.DS);
                this.Informe.get_DataDefinition().get_FormulaFields().get_Item("orden").set_Text("'ordenado por Fecha Entrega'");
                this.CrystalReportViewer1.set_ShowGroupTreeButton(true);
                this.CrystalReportViewer1.set_ReportSource(this.Informe);
                this.CrystalReportViewer1.Zoom(1);
            }
        ...
        private void frmRepOAPend1_Closed(object sender, EventArgs e)
        {
            if (Variables.gOrdenOA != 1)
            {
        ...
        private void frmRepOAPend1_Load(object sender, EventArgs e)
        {
            if (Variables.gOrdenOA == 1)
            {
                this.Text = "Calendario de Armado - O.Armado Atrasadas";
                this.cmbSalir.Text = "&Continuar";
            }
            else
            {
        ...
        {
            ResourceManager manager = new ResourceManager(typeof(frmRepOAPend1));
