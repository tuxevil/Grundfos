namespace SistemaPC
{
    ...
    public class frmTerminales : Form
    {
        ...
        {
            if ((this.BindingContext[this.objDataTermi, "Terminales"].Count > 0) && (Interaction.MsgBox("Desea eliminar este registro?", 20, "Operador") == 6))
            {
        ...
        private void btnUpdate_Click_1(object sender, EventArgs e)
        {
            ...
            {
                Interaction.MsgBox("Debe ingresar terminal", 0x10, "Operador");
                this.editCodigo.Focus();
            }
            else
            {
