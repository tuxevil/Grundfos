namespace SistemaPC
{
    ...
    public class frmDifOCProv1 : Form
    {
        ...
        public frmDifOCProv1()
        {
            ...
            definitions.get_Item("desdefechaexp").set_Text("'" + Strings.Format(DateType.FromString(Variables.gDesde), "dd/MM/yyyy") + "'");
            definitions.get_Item("hastafechaexp").set_Text("'" + Strings.Format(DateType.FromString(Variables.gHasta), "dd/MM/yyyy") + "'");
